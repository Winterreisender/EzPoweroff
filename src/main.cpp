...
int main(int, char**)
{
    ...
    SDL_Window* window = SDL_CreateWindow("EzPoweroff", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 
        360, 90, SDL_WINDOW_OPENGL | SDL_WINDOW_RESIZABLE | SDL_WINDOW_ALLOW_HIGHDPI);
    ...
    while (!done)
    {
        ...
        // 2. Show a simple window that we create ourselves. We use a Begin/End pair to created a named window.
        {
            ...
            ImGui::Begin("Title",NULL,ImGuiWindowFlags_NoDecoration | ImGuiWindowFlags_NoBackground);
